...
// 7. Нехай надано рядок, що складається з українських слів,
// відокремлених одне від одного одним і більше пропусками.
// Сформувати новий рядок в якому усі літеральні назви цифр
// замінені відповідними арабськими цифрами.
